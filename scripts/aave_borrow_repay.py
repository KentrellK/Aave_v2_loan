...
def main():
    ...
    # We are converting borrowable_eth to DAI and then multiplying by 95%
    # to keep a good health factor.
...
def get_borrowable_data(lending_pool, account):
    ...
    print(f"{available_borrow_eth} worth of ETH. available to borrow.")
